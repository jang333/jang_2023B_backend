...
public class Step2 {//c s
    public static void main(String[] args) {// m s
        ...
        //일반호출
        System.out.println("season[0] : "+ season[0]);      //배열내 0번 인덱스호출
        System.out.println("season[1] : "+ season[1]);      //배열내 1번 인덱스호출
        System.out.println("season[2] : "+ season[2]);      //배열내 2번 인덱스호출
        System.out.println("season[3] : "+ season[3]);      //배열내 3번 인덱스호출
        //System.out.println("season[4] : "+ season[4]);    //배열내 4번 인덱스는 없으므로 오류발생
        //.ArrayIndexOutOfBoundsException : 인덱스오류

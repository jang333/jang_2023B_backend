...
public class Step3 {//c s
    public static void main(String[] args) {//m s
        ...
        Scanner scanner = new Scanner(System.in);
            //[3] 객체를 통한 메소드 사용
        //scanner.nextLine();
            //[4] 메소드 호출의 결과[return]를 저장한다.
        String str = scanner.nextLine();
        System.out.println("str = " + str); //soutv
        
        //[ Scanner 제공하는 메소드 ]
            //1. 입력받은 문자열(String) 반환    띄어쓰기 불가
            String str1 =  scanner.next();
            System.out.println("str1 = " + str1);

            scanner.nextLine(); //의미없는 nextLine() 추가해서 nextLine()의 주의점을 해결
            //2. 입력받은 문자열(String) 반환    띄어쓰기 가능 [ 주의할점 : 앞에 next() 있을 경우 하나로 취급 ]
            ...
            //*기본타입 비교시 == / 참조타입(문자열) 비교시 "문자열".equals("비교할문자");
...
/*
    타입
        ...
        2.참조타입(String, Scanner, System, Integer 등)

...
public class Step2 {//c s
    ...
    public static void main(String[] args) {//m s
        ...
        //p.63 연결연산자
        int result1 = 10+2+8;               //숫자일 경우에는 연산   //20
        System.out.println(result1 + "10"); //문자일 경우에는 연결   //2010

        //p.64 문자열을 기본타입으로 변환
            // - JAVA외 애플리케이션과 통신할 때 [메모장, HTTP, 네트워크]
            //HTTP로 부터 10을 받음 -> 문자10? 숫자10? => 문자10
            //메모장으로 부터 10을 받음 -> 문자10? 숫자10? => 문자10
            // - 문자열 -> 기본타입[타입클래스명.parse~~()]
        int value1 = Integer.parseInt("10"); //"10" -> 10
        double value2 = Double.parseDouble("3.14"); //"3.14" -> 3.14
        boolean value3 = Boolean.parseBoolean("true"); //"ture" -> true
        ...
        //1. print( 리터럴 또는 변수명 )
        System.out.print("출력문구1");  //출력만 하고 줄바꿈 처리 안함

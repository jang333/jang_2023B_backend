...
public class Step1 {//c
    public static void main(String[] args) {//m s
        ...
        //int[0] = 10; //NullPointerExcetion
            //배열변수(스택영역)는 있지만, 배열객체(힙영역)가 실제로 존재하지 않음.

        String str = null;
            //스택영역에 변수 생성: 'str'
        //System.out.println("str.length"+str.length()); //NullPointerExcetion
        ...
        hobby = null;
            //hobby변수가 null를 가짐
            //"여행" 객체는 현재 아무도 참조하지 않기 떄문에 잠시후 자동으로 힙영역에서 삭제
        String kind1="자동차";
        ...
        System.out.println("array2 = " + array2[1]);
        //3.
        array2[0]="강호동";
    ...
    //-main()함수는 자바 진입/시작점 --> main()함수 끝나면 힙영역도 모두 사라짐
    ...
    /*
        ...
        5. 배열의 구조
            1.스택은 배열의 0번인덱스 주소를 참조한다.[ 어차피 나열했기 때문에 메모리 할당]
                -인덱스마다 주소값
                -{"유재석","강호동"}; : 102번지 103번지
            String[] array1 = {"유재석","강호동"};

        스택영역                            힙영역
            String[] array1                 1.배열객체 = {"유재석","강호동"};    100번지
                                                        {103번지,104번지};
       ...
       -------------------------------------------------------------------------------
        ...
        스택영역                            힙영역
            String[] array2                 1.배열객체 = {null, null}           201번지
                                            2.배열객체 = {"유재석", null}        201번지
            1.배열내 특정 항목 대입                        {205번지, null}
            array2[0] = "유재석"
                                            3.문자열(유재석)객체                 205번지

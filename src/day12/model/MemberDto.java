...
public class MemberDto {
    ...
    // 오른쪽 클릭 -> 생성 -> 생성자 -> 선택한 필드만큼의 생성자를 생성
    ...
    //3. 메소드
        //1. getter, setter (필드가 private 이면 필수)
    //오른쪽 클릭 -> 생성 -> getter/setter -> 선택한 필드 만큼의 자동 생성
        //2. toString() : 객체 필드정보를 확인 목적
    //오른쪽 클릭 -> 생성 -> toString() -> 선택한 필드 만큼의 자동 생성
